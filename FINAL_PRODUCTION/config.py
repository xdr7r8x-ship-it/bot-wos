"""
Dream Memory - Production Ready Configuration
Auto-detects available AI backend and works immediately
"""

# =============================================================================
# AI BACKEND SELECTION (Auto-detect)
# =============================================================================
# 1. Ollama (Local) - Priority if available
# 2. Gemini (Cloud) - Fallback if key is set
VISION_BACKEND = "auto"

# =============================================================================
# OLLAMA SETTINGS (Local AI - No Limits)
# =============================================================================
OLLAMA_HOST = "http://localhost:11434"
OLLAMA_URL = "http://localhost:11434/api/generate"
OLLAMA_MODEL = "qwen2.5vl:3b"
OLLAMA_STRONG_MODEL = "qwen2.5vl:7b"

# =============================================================================
# GEMINI SETTINGS (Cloud AI - Free Tier)
# =============================================================================
# Get FREE key: https://aistudio.google.com/app/apikey
# Gemini 2.0 Flash: 60 requests/minute FREE
# Set via: $env:GEMINI_API_KEY = "your-key"
# Or edit START.bat and add: set GEMINI_API_KEY=your-key
GEMINI_API_KEY = ""  # Will use environment variable
